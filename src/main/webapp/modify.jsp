        ...
        <tr>
            <td>
                ...
                <table>
                    ...
                    <tr align="center">
                        <td>&nbsp;</td>
                        <td colspan="2"><input type=button class="btn btn-primary" value="수정" onclick="modifyCheck()">
                            <input type=button class="btn btn-light" value="취소" onclick="history.back(-1)">
                        <td>&nbsp;</td>
                    </tr>
                </table>
            </td>
